...
@section('content')
<div class="page-header"><div class="row align-items-center"><div class="col-sm-12"><div class="page-sub-header"><h3 class="page-title">Tambah Mata Pelajaran</h3><ul class="breadcrumb"><li class="breadcrumb-item"><a href="{{ route('mata-pelajaran.index') }}">Mata Pelajaran</a></li><li class="breadcrumb-item active">Tambah</li></ul></div></div></div></div>
<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6"><div class="form-group local-forms"><label>Kelompok <span class="login-danger">*</span></label>
                    <select name="kelompok" class="form-control @error('kelompok') is-invalid @enderror" required>
                        ...
                        <option value="Seni Pilihan" {{ old('kelompok') == 'Seni Pilihan' ? 'selected' : '' }}>Seni Pilihan</option>
                ...
                <div class="col-12"><div class="student-submit"><button type="submit" class="btn btn-primary">Simpan</button></div></div>
            </div>
        </form>
    </div></div></div>
</div>
